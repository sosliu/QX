...
# > 建行生活
^https?:\/\/yunbusiness\.ccb\.com\/clp_service\/ url reject-200
# > 中信银行
...
# > 发现精彩
^https?:\/\/static\.95508\.com\/mmg\/images\/ads\/202\d{5}\/.*.(png|jpg) url reject-200
...
# > 人人视频
# > RRTV_level_info
^https?:\/\/api\.rr\.tv\/\w{3}\/level\/info url script-response-body https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Script/rrtv_json.js
# > RRTV_屏蔽軟件更新
...
^https?:\/\/47\.100\.65\.202\/source\/plugin\/mobile\/mobile\.php\?module=threadpost&.+?&page=1 url script-response-body https://raw.githubusercontent.com/28413761/QX/main/JS/fly.js
# > 京东
...
# > 转转（中间一行小图标被误杀了）
^https?:\/\/pic1\.zhuanstatic\.com\/zhuanzh\/[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}\.png\?t=5&qa=90 url reject-200
...
# > 悟空遥控器
^https?:\/\/img\.wukongtv\.com\/wkremote\/AD\/iOS\/.*.png url reject-200
^https?:\/\/img\.wukongtv\.com\/wkremote\/AD\/iOS\/.*.jpg url reject-200
^https?:\/\/img\.wukongtv\.com\/wkremote\/AD\/iOS\/.*.jpeg url reject-200
# > 马卡龙玩图
...
^http:\/\/app02\.vgtime\.com:8080\/vgtime-app\/api\/v2\/init\/ad\.json url script-response-body https://raw.githubusercontent.com/app2smile/rules/master/js/vgtime.js
# > 天府市民云（生活圈，社区打不开，需要的自己添加主机名）
